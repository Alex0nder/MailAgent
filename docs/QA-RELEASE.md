...
After deploy `GET /v1/agent` should return **40** `mcpTools` (including `mailagent_issue_access`, `mailagent_plan_next`, Workspace Agent tools, and `mailagent_cleanup_inboxes`).
