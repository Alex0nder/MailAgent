...
| npm MCP | `npx -y -p @mailagent/mcp@0.2.6 mailagent-mcp` |
...
```json
{
  ...
  "description": "Temporary inboxes for Codex — OTP, magic links, signup QA, simulate-first autotests (27 MCP tools)."
}
```
